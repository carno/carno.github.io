...
BLOG_AUTHOR = "Carno"  # (translatable)
BLOG_TITLE = "My part of the web"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://blog.carno.pl/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://example.com/"
BLOG_EMAIL = "carno@carno.pl"
BLOG_DESCRIPTION = "A mix of food for thought and what was once called a tech blog with a sprinkle of today I learned"  # (translatable)
